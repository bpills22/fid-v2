...
exports.NEXT_PREVIEW_DATA_COOKIE = exports.NEXT_PRERENDER_BYPASS_COOKIE = exports.EDGIO_IMAGE_PROXY_PATH = exports.NEXT_ROOT_DIR_FILE = exports.NEXT_PRERENDERED_PAGES_FOLDER = exports.SERVICE_WORKER_SOURCE_PATH = exports.SERVICE_WORKER_FILENAME = exports.NEXT_PAGE_HEADER = exports.FAR_FUTURE_TTL_WITH_UNIT = exports.FAR_FUTURE_TTL = void 0;
/**
 ...
 */
exports.FAR_FUTURE_TTL = 60 * 60 * 24 * 365;
/**
 ...
 */
exports.FAR_FUTURE_TTL_WITH_UNIT = '1y';
/**
 * @private
 * Instructs our prod.js in serverless mode which page to render.
 */
exports.NEXT_PAGE_HEADER = 'x-next-page';
/**
 * @private
 * The name of the service worker file.
 */
exports.SERVICE_WORKER_FILENAME = 'service-worker.js';
/**
 * @private
 * The path to the service worker source file
 */
exports.SERVICE_WORKER_SOURCE_PATH = `sw/${exports.SERVICE_WORKER_FILENAME}`;
/**
 * @private
 ...
 */
exports.NEXT_PRERENDERED_PAGES_FOLDER = 'next_prerendered_pages';
/**
 * @private
 * The name of the file which is used to determine the root directory of the Next.js app.
 */
exports.NEXT_ROOT_DIR_FILE = 'NEXT_ROOT_DIR';
/**
 * @private
 * The path where the Edgio Image Proxy is available.
 */
exports.EDGIO_IMAGE_PROXY_PATH = '/__edgio__/image';
/**
 * @private
 * The name of the cookie that is used to bypass the prerendering.
 */
exports.NEXT_PRERENDER_BYPASS_COOKIE = '__prerender_bypass';
/**
 * @private
 * The name of the cookie that stores the preview data.
 */
exports.NEXT_PREVIEW_DATA_COOKIE = '__next_preview_data';
