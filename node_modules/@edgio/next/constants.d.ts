 ...
 */
export declare const FAR_FUTURE_TTL_WITH_UNIT = "1y";
/**
 * @private
 * Instructs our prod.js in serverless mode which page to render.
 */
export declare const NEXT_PAGE_HEADER = "x-next-page";
/**
 * @private
 * The name of the service worker file.
 */
export declare const SERVICE_WORKER_FILENAME = "service-worker.js";
/**
 * @private
 * The path to the service worker source file
 */
export declare const SERVICE_WORKER_SOURCE_PATH: string;
/**
 * @private
 ...
 */
export declare const NEXT_PRERENDERED_PAGES_FOLDER = "next_prerendered_pages";
/**
 * @private
 * The name of the file which is used to determine the root directory of the Next.js app.
 */
export declare const NEXT_ROOT_DIR_FILE = "NEXT_ROOT_DIR";
/**
 * @private
 * The path where the Edgio Image Proxy is available.
 */
export declare const EDGIO_IMAGE_PROXY_PATH = "/__edgio__/image";
/**
 * @private
 * The name of the cookie that is used to bypass the prerendering.
 */
export declare const NEXT_PRERENDER_BYPASS_COOKIE = "__prerender_bypass";
/**
 * @private
 * The name of the cookie that stores the preview data.
 */
export declare const NEXT_PREVIEW_DATA_COOKIE = "__next_preview_data";
