...
exports.getServerBuildAvailability = void 0;
...
let memoized;
const getServerBuildAvailability = ({ config, quiet = false, }) => {
    if (!memoized) {
        const nextVersion = (0, getNextVersion_1.default)();
        let serverBuildAvailable = false, useServerBuild = false, standaloneBuildConfig = {};
        if (nextVersion) {
            serverBuildAvailable = (0, semver_1.satisfies)(nextVersion, '>= 12.0.0');
            if (!(0, isTargetSupported_1.default)(nextVersion)) {
                useServerBuild = true;
...
exports.getServerBuildAvailability = getServerBuildAvailability;
