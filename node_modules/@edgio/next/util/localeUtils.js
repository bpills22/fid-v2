...
exports.startsWithLocale = exports.removeLocale = void 0;
/**
 ...
 */
function removeLocale(path, locales = []) {
    if (!startsWithLocale(path, locales))
        return path;
 ...
 * @returns
 */
function startsWithLocale(path, locales) {
    return locales.length > 0 && new RegExp(`^/(${locales.join('|')})(/|$)`).test(path);
}
exports.startsWithLocale = startsWithLocale;
