...
export default class EdgeFunctionsNodeBuilder extends EdgeFunctionsBuilder {
     ...
     */
    constructor(router: Router, baseDir: string, options?: EdgeFunctionsNodeBuilderOptions);
    /**
     * Returns the code with edge function import as string
     * which can later be inserted into edge functions map.
     * @returns
     */
    protected getFunctionCode(srcPath: string, isInitScript: boolean, failOnBuildError: boolean): string;
    /**
     ...
     * @returns
     */
    bundleIndexCode(indexFilePath: string | undefined, failOnBuildError: boolean, esbuildLogLevel?: LogLevel): Promise<string>;
    /**
     ...
     * @returns
     */
    bundle(indexPath: string, esbuildLogLevel: LogLevel): Promise<any>;
    /**
