...
export default abstract class EdgeFunctionsBuilder {
    ...
    protected abstract getFunctionCode(srcPath: string, isInitScript: boolean, failOnBuildError: boolean): string;
     ...
     * @returns
     */
    getIndexCode(failOnBuildError: boolean): Promise<string>;
}
