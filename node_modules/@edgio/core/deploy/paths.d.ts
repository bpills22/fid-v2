...
export declare const getEntryPoint: (entry: 'dev' | 'prod', appDir: string, connector?: string) => string | undefined;
/**
 ...
 * @returns
 */
export declare function getSrcRouterPath(config?: Config): string;
/**
 * Gets the path to edgio.config.js file
 * @returns
 */
export declare function getSrcConfigPath(): string;
/**
 * Gets the path to '.edgio/lambda/internal/routes.cjs file
 * @returns
 */
export declare function getRoutesPath(): string | import("ts-fs-utils").AbsoluteFileName<import("../index").Router>;
/**
 ...
 * @returns
 */
export declare function getJsInternalPath(): string;
