...
class ModStream extends Mod_1.default {
    ...
    applyStreamingConfig() {
        ...
        response.setIsStreamable(() => {
            ...
            if (hintHeader === null || hintHeader === void 0 ? void 0 : hintHeader.includes(constants_1.EDGIO_CLOUD_FUNCTIONS_HINTS.compute)) {
                return false;
            }
            // do not stream if we do serverless redirect
            if (hintHeader === null || hintHeader === void 0 ? void 0 : hintHeader.includes(constants_1.EDGIO_CLOUD_FUNCTIONS_HINTS.redirect)) {
                return false;
            }
