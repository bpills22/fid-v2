...
class ModSetEnv extends Mod_1.default {
    ...
    applyHeaders(features, _phase) {
        ...
        if (_phase === Phase_1.default.HandleResponseHeader ||
            ...
            if ((_b = features.headers) === null || _b === void 0 ? void 0 : _b.set_response_headers)
                this.context.setResponseHeader(features.headers.set_response_headers);
            if ((_c = features.headers) === null || _c === void 0 ? void 0 : _c.add_response_headers)
                this.context.setResponseHeader((_d = features.headers) === null || _d === void 0 ? void 0 : _d.add_response_headers, true);
            if ((_e = features.headers) === null || _e === void 0 ? void 0 : _e.remove_response_headers)
                features.headers.remove_response_headers.forEach(header => response.removeHeader(header));
            if ((_f = features.response) === null || _f === void 0 ? void 0 : _f.set_status_code)
