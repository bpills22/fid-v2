...
import { Features, HttpResponseHeader, Rules, EdgeFunctions } from '../types';
...
export default class RequestContext {
     ...
     * @param callback
     */
    forEachMatchingRule(callback: (features: Features, ruleIndex: number) => void): void;
    /**
     * Calls the specified callback for last matching rule.
     * @param callback return true to confirm the match
     */
    forLastMatchingRule(callback: (features: Features, ruleIndex: number) => boolean): void;
    /**
