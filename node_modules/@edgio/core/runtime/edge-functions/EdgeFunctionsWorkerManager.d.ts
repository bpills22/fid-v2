...
export default class EdgeFunctionsWorkerManager {
    ...
    private enabledResponseBodyChunkCount;
    private workerIsWaiting;
    private static fetchImpl;
    constructor(context: RequestContext, rawBody: Buffer | undefined, path: string, sysVars: Map<string, string | Uint8Array>, envVars: Map<string, string>, usrVars: Map<string, string>, httpVars: Map<string, string>);
