...
export default interface Request {
    ...
    path: string;
    /**
     * Raw url as received from downstream. Includes query string.
     * We can remove the private tag and publish this publicly once
     * subaccount v1.38.12 is rolled out widely.
     * @private
     */
    rawUrl: string;
    /**
