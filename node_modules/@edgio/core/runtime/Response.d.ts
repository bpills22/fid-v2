...
export default interface Response {
     ...
     * @private we shouldn't combine body and write in compute - at the moment, we'll keep using body
     */
    write: (data: any) => void;
    /**
     * Ends the response
     * @private users shouldn't end response from compute
     */
    end: () => void;
    /**
    ...
    clear: () => void;
    /**
     * Allows to clear previously set headers
     * @private
     */
    clearHeaders: () => void;
    /**
