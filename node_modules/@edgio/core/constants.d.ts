 ...
 * @private
 */
export declare const EDGIO_EDGE_FUNCTION_DEFAULT_VERSION = 2;
/**
 ...
 */
export declare const EDGIO_MAX_NESTED_REQUESTS = 3;
/**
 * The value that is appended to the 'Via' header
 * everytime request goes through the @edgio/core.
 */
export declare const EDGIO_VIA_HEADER_VALUE = "Edgio Core";
/**
...
export declare const INVOKE_SOURCES: {
    readonly functionUrl: "function-url";
    readonly console: "console";
    readonly bufferProxy: "buffer-proxy";
};
export type InvokeSource = (typeof INVOKE_SOURCES)[keyof typeof INVOKE_SOURCES];
export declare const INVOKE_ACTIONS: {
    readonly getEdgeConfig: "getEdgeConfig";
    readonly getPreloadConfig: "getPreloadConfig";
    readonly serverless: "serverless";
    readonly simulator: "simulator";
};
export type InvokeAction = (typeof INVOKE_ACTIONS)[keyof typeof INVOKE_ACTIONS];
export declare const EDGIO_READY_MESSAGE = "> Edgio ready on ";
