export declare function deepRequestInspectionLogger(): {
    logDownstreamRequestInfo: (data: any) => void;
    logDownstreamResponseInfo: (data: any) => void;
    logUpstreamRequestInfo: (data: any) => void;
    logUpstreamResponseInfo: (data: any) => void;
    logUpstreamResponseBodyInfo: (data: any) => void;
};
