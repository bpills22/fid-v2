...
export default interface DevServerOptions {
    ...
    /**
     * Additional list of directories to watch for changes.
     * The dev server is restarted when any of these directories change.
     * For instance, if you have an Express server in your folder inside
     * app.js file, you can specify that you want to restart the dev server
     * whewnever app.js changes.
     */
    reloadAppOnChangeOf?: string[];
    /**
