...
async function install(options) {
    ...
    const { prefetchURLs, watch, serviceWorkerPath = '/service-worker.js', serviceWorkerScope = '/', observe, prefetchPatterns = [], onServiceWorkerStateChange, onServiceWorkerRegistered, } = options;
