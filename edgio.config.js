module.exports = {
  ...
  environments: {
    default: {
      hostnames: [
        { hostname: "flightaware.bpillsbury.com", origin: "origin" }, // Points to Nginx origin
        { hostname: "assets-flightaware.bpillsbury.com", origin: "digitalocean" }, // Points to DigitalOcean origin
      ],
    },
  },
};
